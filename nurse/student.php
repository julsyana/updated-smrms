                  ...
                  <table class="table table-borderless shadow mt-3 text-center align-middle">
                    ...
                    <tbody>
                      ...
                      <tr class="">
                        ...
                        <td class="col-2  text-light fw-bold" style="background:#5D8FD9;width:max-content">
                          <span> <?= $studs['student_id'] ?> </span>
                        </td>

                        <td class="col-3 text-start"><span class="name">
                          <?= $studs['firstname'] ?> <?= $studs['middlename'] ?> <?= $studs['lastname'] ?></span>
                        </td>

                        <td class="col-1">
                          <span class="course"><?= $studs['section'] ?></span>
                        </td>

                        <td class="col-5 text-start">
                          <span class="email"><?= $studs['email'] ?></span>
                        </td>
